        ...
        <div class="container">
            <div class="main">
                ...
                <div id="unit-content">
                    ...
                    <div class="description" v-html="(descriptionPieces > 1 && !showMore ? cutDescription[0] + '...' : cutDescription[0] + cutDescription[1])">
                    </div>

                    <span class="showMore" @click="toggleShowMore()" v-html="showMore ? 'Leer menos' : 'Leer más'"></span>
                ...
                <div id="unit-features">
                    ...
                    <Feature icon="energy" line1="Consumo de energía" :line2="$page.unit.energy.consumption + 'Mw h m<sup>2</sup>/año'"/>
